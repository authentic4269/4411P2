 ...
 */
extern int linkedList_insert(linkedList_t list, int key, void* data);

extern int linkedList_get(linkedList_t list, int key, void **item);
 ...
 */
extern int linkedList_dequeue(linkedList_t list, void** item);
 ...
 */
extern int linkedList_delete(linkedList_t linkedlist, int key);
