...
all: test1 test2 test3 buffer sieve alarmtest queuetest multilevelqueuetest alarmthreadtest network1 network2 network3 network4 network5 network6 conn-network1 conn-network2 conn-network3
